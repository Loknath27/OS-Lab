...
```
# Output
![Semsphore output](a semaphore.png)
...
## Conclusion
Thus the study and execution of the control the number of ports opened systems with a) semaphore b) monitor has been completed successfully
